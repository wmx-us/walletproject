...
// 验证码生成和校验地址配置
// http://insland.test.szyz.top
export const configAddress = {
  // requestCaptchaDataUrl: "http://insland.test.szyz.top:8083/captcha/gen/random",
  // validCaptchaUrl: "http://insland.test.szyz.top:8083/captcha/check3",
  requestCaptchaDataUrl: "http://insland.test.szyz.top:8083/captcha/gen/random",
  validCaptchaUrl: "http://insland.test.szyz.top:8083/captcha/check3",
  bindEl: "#captcha-div",
