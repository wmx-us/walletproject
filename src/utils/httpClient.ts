  ...
  public constructor(config: AxiosRequestConfig) {
    ...
    this.service.interceptors.request.use(
      (_config) => {
        ...
        _config.headers["token"] = Global.state.token ||
    ...
    /**
     * @description 响应拦截器服务器换返回信息 -> [拦截统一处理] -> 客户端JS获取到信息
     */
...
export const httpClient = (options: HttpRequestOptions): RequestHttp =>
  new RequestHttp(options);
